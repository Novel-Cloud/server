...
(
    ...
    constraint FKbnpka2j28v795sf6of61okbwq
        foreign key (mutable_attach_files_id) references artwork (id),
...
(
    ...
    constraint FK1mlegl78k27w12vl7gu53tan1
        foreign key (mutable_bookmarks_id) references artwork (id),
...
(
    ...
    constraint FK5au6krj8diwmav7ugiwokgmpf
        foreign key (mutable_comments_id) references artwork (id),
    constraint FKde3rfu96lep00br5ov0mdieyt
        foreign key (parent_id) references comment (id),
    constraint FKdv2x2ac1m8exft0dps6b9veq5
        foreign key (mutable_children_id) references comment (id),
    constraint FKjqppol81l9gsfxdj3ndq0n8c0
        foreign key (children_comments_id) references comment (id),
...
create table artwork_tag_assoc
(
    artwork_id bigint not null,
...
create table temporary_artwork
(
    id                 bigint auto_increment
        primary key,
    created_date       datetime(6)    not null,
